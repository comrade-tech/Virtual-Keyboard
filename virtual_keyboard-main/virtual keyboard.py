...
from graph import graphh, graph1,graph2,graph3
...
showKey.x = int(frameWidth*1.5) - 70
exitKey.x = int(frameWidth*1.5) - 70
#print(showKey.x)
...
while True:
    ...
    showKey.drawKey(frame,(255,255,255), (128,0,0),0.1, fontScale=0.5)
    exitKey.drawKey(frame,(255,255,255), (128,0,0),0.1, fontScale=0.5)
    ...
    alpha = 0.5
    if show:
        textBox.drawKey(frame, (255,255,255), (128,128,128), 0.3)
        for k in keys:
            ...
            k.drawKey(frame,(0,0,0), (128,0,0), alpha=alpha)
            alpha = 0.5
        clickedX, clickedY = 0, 0        
    ptime = ctime
